...
class mycabbage extends StatefulWidget {
  const mycabbage({super.key});

  @override
  State<mycabbage> createState() => _mycabbageState();
}

class _mycabbageState extends State<mycabbage> {
  @override
          ...
          child: Container(
            ...
            child: Column(
                      ...
                      children: [
                        ...
                        Center(child: Image.asset("assets/cabbage.png" ,height: 200, width: 300,)),
                        Text("Cabbage",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,),),
