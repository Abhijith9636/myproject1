...
class mytomato extends StatefulWidget {
  const mytomato({super.key});

  @override
  State<mytomato> createState() => _mytomatoState();
}

class _mytomatoState extends State<mytomato> {
  @override
          ...
          child: Container(
            ...
            child: Column(
                      ...
                      children: [
                        ...
                        Center(child: Image.asset("assets/tomato.png" ,height: 200, width: 300,)),
                        Text("Tomato",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,),),
